...
},{}],"components/modals.js":[function(require,module,exports) {
"use strict";
...
var declareDepartureModal = document.querySelector('#declareDepartureModal');
var declareModalBtn = document.querySelectorAll('.declare-modal-btn');
var confirmModal = document.querySelector('#confirmModal');

var modalBtnEnventManger = function modalBtnEnventManger(type, btn, modal) {
  if (type === 'open') {
...
var modals = function modals() {
  ...
  if (declareModalBtn.length > 0) {
    modalBtnEnventManger('open', Array.from(declareModalBtn)[0], declareDepartureModal);
    modalBtnEnventManger('open', Array.from(declareModalBtn)[1], declareDepartureModal);
...
module.exports = {
  ...
  "_spec": "axios@0.21.4",
  "_where": "C:\\Users\\FUTURE\\Desktop\\SafeJ",
  "author": {
    "name": "Matt Zabriskie"
  },
  "browser": {
...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"utils/loadingBtn.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.loadingBtn = void 0;

var loadingBtn = function loadingBtn(btn, status) {
...
},{}],"utils/handleAjaxError.js":[function(require,module,exports) {
"use strict";
...
var handleError = function handleError(err) {
  if (err.response) {
     ...
     */
    (0, _alert.showAlert)('error', 'Something went wrong! It might be unstable network connection.');
  } else {
    // Something happened in setting up the request and triggered an Error
    (0, _alert.showAlert)('error', 'Something unexpectedly happend! Please try again.');
  }
};

exports.handleError = handleError;
},{"./alert":"utils/alert.js"}],"controller/departure.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getDeparturesSummary = void 0;

var _axios = _interopRequireDefault(require("axios"));

var _alert = require("../utils/alert");

var _loadingBtn = require("../utils/loadingBtn");

var _modals = require("../components/modals");

var _handleAjaxError = require("../utils/handleAjaxError");
...
var declareDepartureModal = document.querySelector('#declareDepartureModal');
var confirmModal = document.querySelector('#confirmModal');
var declareDepartureForm = document.querySelector('.form--declareDeparure');
var confirmForm = document.querySelector('.form--confirm'); // 1) Declare Departure

if (declareDepartureForm) {
  declareDepartureForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var formElements, phoneOrEmail, passenger, districtOfDep, districtOfDest, date, btn;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              formElements = declareDepartureForm.elements;
              phoneOrEmail = formElements['phoneOrEmail'].value;
              passenger = formElements['passenger'].value;
              districtOfDep = formElements['districtOfDep'].value;
              districtOfDest = formElements['districtOfDest'].value;
              date = formElements['date'].value;
              btn = formElements['declareBtn'];
              (0, _loadingBtn.loadingBtn)(btn, 'disable');
              _context.next = 11;
              return declareDeparture(phoneOrEmail, passenger, districtOfDep, districtOfDest, date);

            case 11:
              (0, _loadingBtn.loadingBtn)(btn, 'enable');
...
if (confirmForm) {
  confirmForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
      var formElements, emailOrPhone, btn;
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              e.preventDefault();
              formElements = confirmForm.elements;
              emailOrPhone = formElements['emailOrPhone'].value;
              btn = formElements['btn-form-confirm'];
              (0, _loadingBtn.loadingBtn)(btn, 'disable');
              _context2.next = 7;
              return confirmDeparture(emailOrPhone, confirmModal);
...
document.addEventListener('click', function (e) {
  if (e.target.classList.contains('searchDeparturesForm__btn')) {
    e.target.parentElement.addEventListener('submit', /*#__PURE__*/function () {
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                e.preventDefault();
                date = document.querySelector('.searchDeparturesForm__input').value;
                btn = document.querySelector('.searchDeparturesForm__btn');
                (0, _loadingBtn.loadingBtn)(btn, 'disable');
                _context3.next = 6;
                return getDepartures(_accountPage.depSite.departuresite, date);
...
var declareDeparture = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(phoneOrEmail, passenger, districtOfDep, districtOfDest, date) {
    var res;
        ...
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            return (0, _axios.default)({
              ...
              data: {
                ...
                passenger: passenger,
                districtOfDep: districtOfDep,
                districtOfDest: districtOfDest,
                date: date
              }
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Departure declared successfully');
              (0, _modals.closeModal)(declareDepartureModal);
            }
          ...
          case 7:
            ...
            (0, _handleAjaxError.handleError)(_context4.t0);
  ...
  return function declareDeparture(_x4, _x5, _x6, _x7, _x8) {
    return _ref4.apply(this, arguments);
  };
}();

var confirmDeparture = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(emailOrPhone) {
    var res;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "/api/v1/departures/".concat(emailOrPhone, "/confirmDeparture")
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Departure confirmed');
              _index.state.departures.pending--;
              _index.state.departures.departed++;
              _index.state.departures.allDepartures = _index.state.departures.pending + _index.state.departures.departed;
              (0, _accountPage.renderDashboard)();
              (0, _modals.closeModal)(confirmModal);
            }
          ...
          case 7:
            ...
            (0, _handleAjaxError.handleError)(_context5.t0);
  ...
  return function confirmDeparture(_x9) {
    return _ref5.apply(this, arguments);
  };
}();

var getDeparturesSummary = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(departuresite) {
    var url, res;
    return regeneratorRuntime.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            _context6.prev = 0;
            url = "/api/v1/departures/getDeparturesSummary/".concat(departuresite);
            _context6.next = 4;
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              _index.state.departures = {};
              _index.state.departures.pending = 0;
              _index.state.departures.departed = 0;
              res.data.data.summary.forEach(function (el) {
                if (!el.departed) {
                  _index.state.departures.pending = el.num;
                }

                if (el.departed) {
                  _index.state.departures.departed = el.num;
                }
              });
              _index.state.departures.allDepartures = _index.state.departures.pending + _index.state.departures.departed;
              (0, _accountPage.renderDashboard)();
          ...
          case 8:
            ...
            (0, _handleAjaxError.handleError)(_context6.t0);
  ...
  return function getDeparturesSummary(_x10) {
    return _ref6.apply(this, arguments);
  };
}();

exports.getDeparturesSummary = getDeparturesSummary;

var getDepartures = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(departuresite, date) {
    var res;
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            _context7.prev = 0;
            _context7.next = 3;
            return _axios.default.get("/api/v1/departures/districtDepartures/".concat(departuresite, "/date/").concat(date));

          case 3:
            res = _context7.sent;

            if (res.data.status === 'success') {
              _index.state.departures.plannedDep = res.data.data;
              (0, _accountPage.renderDepartures)();
            }
          ...
          case 7:
            ...
            (0, _handleAjaxError.handleError)(_context7.t0);
  ...
  return function getDepartures(_x11, _x12) {
    return _ref7.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","../utils/alert":"utils/alert.js","../utils/loadingBtn":"utils/loadingBtn.js","../components/modals":"components/modals.js","../utils/handleAjaxError":"utils/handleAjaxError.js","../components/accountPage":"components/accountPage.js","../index":"index.js"}],"utils/str.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.capitalizeStr = void 0;
...
},{}],"components/accountPage.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.renderDepartures = exports.renderDashboard = exports.depSite = void 0;
...
var _departure = require("../controller/departure");
...
var sideNavDashboard = document.querySelector('.side-nav__dashboard');
var sideNavDepartures = document.querySelector('.side-nav__departures');
var sideNavSettings = document.querySelector('.side-nav__settings');
...
var depSite;
exports.depSite = depSite;

if (userName) {
  exports.depSite = depSite = JSON.parse(JSON.stringify(userName.dataset));
} // Delegation


if (sideNavSettings) {
  sideNavSettings.addEventListener('click', function () {
    addRemoveActiveClass([sideNavDashboard, sideNavDepartures], sideNavSettings);
    renderSettings();
  });
}

if (sideNavDashboard) {
  sideNavDashboard && sideNavDashboard.addEventListener('click', function () {
    addRemoveActiveClass([sideNavDepartures, sideNavSettings], sideNavDashboard);
    renderDashboard();
  });
}

if (sideNavDepartures) {
  sideNavDashboard && sideNavDepartures.addEventListener('click', function () {
    addRemoveActiveClass([sideNavDashboard, sideNavSettings], sideNavDepartures);
    renderDepartures();
  });
}

var addRemoveActiveClass = function addRemoveActiveClass(deactivate, activate) {
  deactivate.forEach(function (element) {
...
document.addEventListener('click', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
    var formElements, name, email, btn, user;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            formElements = e.target.parentElement.parentElement;
            name = formElements['name'].value;
            email = formElements['email'].value;
            btn = formElements['formUserDataBtn'];
            (0, _loadingBtn.loadingBtn)(btn, 'disable');
            _context.next = 8;
...
document.addEventListener('click', /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
    var formElements, currentPassword, password, passwordConfirm, btn;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            formElements = e.target.parentElement.parentElement;
            currentPassword = formElements['password-current'].value;
            password = formElements['newPassword'].value;
            passwordConfirm = formElements['password-confirm'].value;
            btn = formElements['formUserPasswordBtn'];
            (0, _loadingBtn.loadingBtn)(btn, 'disable');
            _context2.next = 9;
            return updateSettings('password', {
...
var updateSettings = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(type, data) {
    var url, res;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 4:
            ...
            return _context3.abrupt("return", res.data.data.user);
          ...
          case 10:
            ...
            (0, _handleAjaxError.handleError)(_context3.t0);
    ...
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            res = _context4.sent;
            _index.state.user = res.data.data.user;
...
var renderDashboard = function renderDashboard() {
  if (_index.state.departures) {
    var confirmedDeparturesPer = _index.state.departures.departed / _index.state.departures.allDepartures * 100;
    var pendingDeparuresPer = _index.state.departures.pending / _index.state.departures.allDepartures * 100;
    account__content.innerHTML = '';
    var markup = "<div class=\"account__header\">\n\t\t\t\t\t\t<h1 class=\"tertiary-heading gradient\"><b>Site: ".concat(depSite.departuresite, " </b></h1>\n\t\t\t\t\t\t<button class=\"btn btn--secondary btn--blue confirmBtn\" id=\"confirmBtn\">&plus; Confirm Departure</button>\n\t\t\t\t\t</div>\n\n\t\t\t\t\t<div class=\"account__body\">\n\t\t\t\t\t\t<div class=\"dashboard\">\n\t\t\t\t\t\t\n\t\t\t\t\t\t<div class=\"dashboard__header\">\n\t\t\t\t\t\t\t<form class=\"form-dashboard\">\n\t\t\t\t\t\t\t<div class=\"form-dashboard__group\" style=\"display: inline-block;\">\n\t\t\t\t\t\t\t\t<label class=\"form-dashboard__label\" for=\"departureDate\">Select date to track</label>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t<div class=\"form-dashboard__form-group\">\n\t\t\t\t\t\t\t\t<input class=\"form-dashboard__input\" id=\"departureDate\" type=\"text\" list=\"departureDates\" placeholder=\"Date...\"/>\n\t\t\t\t\t\t\t\t<datalist id=\"departureDates\">\n\t\t\t\t\t\t\t\t<option alue=\"23/09/2021\"></option>\n\t\t\t\t\t\t\t\t<option value=\"23/07/2021\"></option>\n\t\t\t\t\t\t\t\t<option value=\"23/04/2021\"></option>\n\t\t\t\t\t\t\t\t</datalist>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t</form>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class=\"dashboard__body\">\n\t\t\t\t\t\t\t<div class=\"cards\">\n\t\t\t\t\t\t\t<div class=\"card--dashboard\">\n\t\t\t\t\t\t\t\t<div class=\"card--dashboard__header\">All Departures</div>\n\t\t\t\t\t\t\t\t<div class=\"card--dashboard__body\">").concat(_index.state.departures.allDepartures, "</div>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t<div class=\"card--dashboard\">\n\t\t\t\t\t\t\t\t<div class=\"card--dashboard__header\">Confirmed</div>\n\t\t\t\t\t\t\t\t<div class=\"card--dashboard__body\">").concat(_index.state.departures.departed, "</div>\n\t\t\t\t\t\t\t\t<div class=\"card--dashboard__footer\">").concat(confirmedDeparturesPer.toFixed(2), "%</div>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t<div class=\"card--dashboard\">\n\t\t\t\t\t\t\t\t<div class=\"card--dashboard__header\">Pending</div>\n\t\t\t\t\t\t\t\t<div class=\"card--dashboard__body\">").concat(_index.state.departures.pending, "</div>\n\t\t\t\t\t\t\t\t<div class=\"card--dashboard__footer\">").concat(pendingDeparuresPer.toFixed(2), "%</div>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\n\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t");
    account__content.insertAdjacentHTML('afterbegin', markup);
  } else {
    account__content.innerHTML = '';
    account__content.insertAdjacentHTML('afterbegin', "\n\t\t\t\t\t<div class=\"account__header\">\n\t\t\t\t\t\t<h1 class=\"tertiary-heading gradient\"><b>Site: Muhanga </b></h1>\n\t\t\t\t\t\t<button class=\"btn btn--secondary btn--blue confirmBtn\" id=\"confirmBtn\">&plus; Confirm Departure</button>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class=\"dashboard\">\n\t\t\t\t\t\t\n\t\t\t\t\t\t<div class=\"dashboard__header\">\n\t\t\t\t\t\t\t<form class=\"form-dashboard\">\n\t\t\t\t\t\t\t<div class=\"form-dashboard__group\" style=\"display: inline-block;\">\n\t\t\t\t\t\t\t\t<label class=\"form-dashboard__label\" for=\"departureDate\">Select date to track</label>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t<div class=\"form-dashboard__form-group\">\n\t\t\t\t\t\t\t\t<input class=\"form-dashboard__input\" id=\"departureDate\" type=\"text\" list=\"departureDates\" placeholder=\"Date...\"/>\n\t\t\t\t\t\t\t\t<datalist id=\"departureDates\">\n\t\t\t\t\t\t\t\t<option alue=\"23/09/2021\"></option>\n\t\t\t\t\t\t\t\t<option value=\"23/07/2021\"></option>\n\t\t\t\t\t\t\t\t<option value=\"23/04/2021\"></option>\n\t\t\t\t\t\t\t\t</datalist>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t</form>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class=\"dashboard__body\">\n\t\t\t\t\t\t\t<div class=\"cards\">\n\t\t\t\t\t\t\t\t<span class=\"skeleton-1\"></span>\n\t\t\t\t\t\t\t\t<span class=\"skeleton-1\"></span>\n\t\t\t\t\t\t\t\t<span class=\"skeleton-1\"></span>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t");
    (0, _departure.getDeparturesSummary)(depSite.departuresite);
  }
}; // Render Departures
...
var renderDepartures = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            if (!_index.state.departures.plannedDep) {
              account__content.innerHTML = '';
              markup = createTable('no_deps_prop');
              account__content.insertAdjacentHTML('afterbegin', markup);
            }

            if (_index.state.departures.plannedDep && _index.state.departures.plannedDep.length != 0) {
  ...
  return function renderDepartures() {
    return _ref5.apply(this, arguments);
  };
}();

exports.renderDepartures = renderDepartures;

var createTable = function createTable(controller) {
  var markup;
  ...
  if (controller === 'deps') {
    var tableRaws = _index.state.departures.plannedDep.departures.map(function (dep, index) {
      return "\n\t\t\t\t\t\t<li class=\"table-row\">\n      \t\t\t\t\t\t<div class=\"col col-1\">".concat(index + 1, "</div>\n      \t\t\t\t\t\t<div class=\"col col-2\">").concat((0, _str.capitalizeStr)(dep.destination), "</div>\n      \t\t\t\t\t\t<div class=\"col col-3\">").concat(dep.passengerNum, "</div>\n      \t\t\t\t\t</li>\n\t\t\t\t\t");
    }).join('');

    markup = "<div class=\"account__header\">\n\t\t\t\t\t<h1 class=\"tertiary-heading gradient\"><b>Site: ".concat((0, _str.capitalizeStr)(depSite.departuresite), " </b></h1>\n\t\t\t\t\t<form class=\"searchDeparturesForm\">\n\t\t\t\t\t\t<input type=\"date\" class=\"searchDeparturesForm__input\"/>\n\t\t\t\t\t\t<button type=\"submit\" class=\"btn btn--secondary btn--blue searchDeparturesForm__btn\">Search</button>\n\t\t\t\t\t</form>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"account__body\">\n\t\t\t\t\t<div class=\"planedDepartures\">\n\t\t\t\t\t\t<div class=\"planedDepartures__header\">\n\t\t\t\t\t\t\t<h3 class=\"tertiary-heading color-black f-size-6\">Planned Departures On ").concat(_index.state.departures.plannedDep.date, "</h3>\n\t\t\t\t\t\t\t<button class=\"btn btn--secondary btn--blue btnPrint\">Print</button>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class=\"table_container\">\n\t\t\t\t\t\t\t<ul class=\"responsive-table\">\n\t\t\t\t\t\t\t<li class=\"table-header\">\n\t\t\t\t\t\t\t<div class=\"col col-1\">#</div>\n\t\t\t\t\t\t\t<div class=\"col col-2\">Destination</div>\n\t\t\t\t\t\t\t<div class=\"col col-3\">Number</div>\n\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t").concat(tableRaws, "\n\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t</ul>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>");
  }

  return markup;
};
},{"axios":"../../node_modules/axios/index.js","../utils/loadingBtn":"utils/loadingBtn.js","../utils/alert":"utils/alert.js","../utils/handleAjaxError":"utils/handleAjaxError.js","../controller/departure":"controller/departure.js","../utils/str":"utils/str.js","../index":"index.js"}],"controller/authentication.js":[function(require,module,exports) {
"use strict";
...
var logoutBtn = document.querySelector('#logoutBtn'); // 1) Login

if (loginForm) {
  loginForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var formElements, email, password, btn;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              formElements = loginForm.elements;
              email = formElements['email'].value;
              password = formElements['password'].value;
              btn = formElements['btn-form-login'];
              (0, _loadingBtn.loadingBtn)(btn, 'disable');
              _context.next = 8;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _handleAjaxError.handleError)(_context2.t0);
...
},{"axios":"../../node_modules/axios/index.js","../utils/alert":"utils/alert.js","../utils/loadingBtn":"utils/loadingBtn.js","../utils/handleAjaxError":"utils/handleAjaxError.js"}],"index.js":[function(require,module,exports) {
'use strict';
...
var createPdf = function createPdf() {
  var dd = {
    content: [{
      ...
      text: "Planned Departures from ".concat((0, _str.capitalizeStr)(state.departures.plannedDep.from), ", on ").concat(state.departures.plannedDep.date, "\n\n"),
      style: 'title'
    }, {
      table: {
        headerRows: 1,
        ...
        body: [[{
          ...
          bold: true,
          fontSize: 16
        }], [state.departures.plannedDep.departures.map(function (_, index) {
          return index + 1;
        }), state.departures.plannedDep.departures.map(function (dep, index) {
          return (0, _str.capitalizeStr)(dep.destination);
        }), state.departures.plannedDep.departures.map(function (dep, index) {
          return dep.passengerNum;
        })]]
      }
    }],
    styles: {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "9086" + '/');
